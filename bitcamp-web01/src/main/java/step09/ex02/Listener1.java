...
// 리스너
// => 특정 상태가 되었을 대 작업을 수행하는 객체
// => 특정 상태에 도달했을 때의 시각 또는 걸린 시간을 기록하여 
//    서버의 실행 상태를 보여주는 모니터링 시스템을 만들 때 유용하다.
// 예) 애플리케이션 성능 관리(=모니터링) 시스템(Application Perfermance Management System; APM)

// 서블릿 컨테이너에서 발생하는 이벤트(event, 사건, 상태)
// 1) 서블릿 컨테이너가 시작/종료 이벤트
// 2) 요청이 시작/종료 이벤트
...
// 리스너 만들기
// => 이벤트가 발생했을 때 어떤 메서드를 호출할 지 서블릿 기술에 명세되어 있다.
...
//      <listener>
//          <listener-class>step09.ex02.Listener1</listener-class>
//      </listener>
