...
public class Exam03 extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        // 용도:
        //      작업 결과를 출력한 후에 지정된 페이지로 이동시키고 싶을 때 사용
        ...
        //   출력했던 내용이 버려진다.
        // - 어? 이미 클라이언트로 보냈는데 어떻게 그 데이터를  버릴 수 있나요?
        ...
        //   redirect를 할 수 없다.
        //   그것을 떠나서 내가 분명히 redirect는 클라이언트에게 먼가를 출력하지 않고,
        //   다른 URL로 이동하라는 내용만 전달한다고 사용한다고 했다.
        //   그런데도 불구하고 redirect를 사용할 거면서 출력하는 것은 뭐냐?
