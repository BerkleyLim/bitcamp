// 서브릿을 서블릿 컨테이너에 배치하기 : 애노테이션으로 설정하는 방법 
package step02;
...
// 서블릿 클래스에 @WebServlet 애노테이선을 붙이면
