...
public class Exam04 extends GenericServlet {
    ...
    public void service(ServletRequest request, ServletResponse response)
        ...
        //         - 영어인 경우네는 앞에 0x00을 붙이면 UTF-16이기 때문에 아무런 문제가 없다.
        ...
        //    클라이언트가 보낸 문자코드가 어떤 문자코드로 되어 있는지 알려줘야 한다.
        ...
        // => server.xml 설정 파일에서 다음 태그에 URIEncoding 속성을 추가하라
        /*     <Connector 
                    connectionTimeout="20000" 
                    port="8888" 
                    protocol="HTTP/1.1" 
                    redirectPort="8443"
                    URIEncoding="UTF-8"/> <!-- 톰캣 7버전에선 무조건 URIEncoding="UTF-8" 추가 -->
         * */
