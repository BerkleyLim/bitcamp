...
public class Exam06_3 {
    ...
    @GetMapping(value="m1")  
    public String m1() {
        // 리턴 값으로 JSP URL을 알려주면 된다.
        return "/exam06_3.jsp";
    }
    
    // 이경우는 잘 안쓴다. 이미 나와서 알려주는 거다
    @GetMapping(value="m2")  
    public View m2() {
    ...
    @GetMapping(value="m4")  
    public String m4() {
        // 보통 redirect는 문자열로 URL에 "redirect:"라는 접두어를 붙여서 문자열로 리턴한다.
        return "redirect:../exam06_1/m2";
    }

    @GetMapping(value="m5")  
    public ModelAndView m5() {
        // 데이터와 함께 view URL을 리턴할 때 ModelAndView 객체를 사용하기도 한다.
