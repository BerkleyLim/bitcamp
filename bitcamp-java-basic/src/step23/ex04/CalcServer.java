...
//=> 단점:
//   매번 요청할 대마다 서버에 연결해야 하기 때문에 실행 시간이 많이 걸린다.
...
//   왜?
//   클라이언트와 연결을 계속 유지하기 않기 때문에 작업을 처리하는 동안만 연결정보를 유지한다.
//   그래서 같은 메모리라도 더 많은 클라이언트의 요청을 처리할 수 있다.
//   더 많은 클라이언트이 요청을 처리할 수 있다.
//=> 대표적인 예:
