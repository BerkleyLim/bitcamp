...
public class Exam01_3 {
    public static void main(String[] args) {
        ...
        // 컴파일러가 경고를 띄운다. 물론 경고는 무시해도 실행에 문제 없음
        ...
        //map3.put("aaa", "문자열"); // 컴파일 오류! <true, false>
        //map3.put(new Integer(100), new Member("홍길동", 20); // 컴파일 오류 <false, true>
        map3.put("aaa", new Member("홍길동", 20));  // OK! <true, true>
    }
}
