...
public class Exam02_1 {
    ...
    //    => 함수 블록에 들어있는 명령어를 수행 완료한 후 그 결과로 놓이는 값.
    // - 파라미터(parameter) 선언?
    ...
    public static void main(String[] args) {
        // 1) 메서드를 사용하는 방법
        // [리턴값을 받을 변수[] = 메서드명(argument)
        // - argument?
        //   => 메서드 블록에 들어 있는 명령어를 실행하기 위해 넘겨주는 값
        //   => 즉 파라미터 변수에 넘겨주는 값
        //   => 파라미터 변수의 타입과 개수와 순서에 맞게 값을 넘겨줘야 한다.
        //      만약 변수의 타입과 값의 타입이 타르면 컴파일 오류!
        ...
        // hello 메서드는 파라미터 변수가 없기 대문에 호출할 때 값을 넣으면
        //hello(100); // 컴파일 오류!

        // hello 메서드는 값을 리턴하지 않기 때문에 변수를 값을 받으려 하면
        int i;
        //i = hello(); // 컴파일 오류!
    }
}
