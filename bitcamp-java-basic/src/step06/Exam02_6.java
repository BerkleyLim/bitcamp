...
public class Exam02_6 {
    ...
    public static void main(String[] args) {
        ...
        hello(arr); // 이 경우 names 배열의 개수는 4이다.
        System.out.println("-------------------------");
        
        
        System.out.println("배열 파라미터");
        // 배열 파라미터의 메서드를 호출할 때는
        // => 가변 파라미터와 달리 낱개의 값을 여러개 줄 수 없다.
       // hello2("홍길동", "임꺽정", "유관순"); // 이 경우 names 배열의 개수는 3이다.
       // System.out.println("-------------------------"); 

        // => 오직 배열에 담아서 전달해야 한다.
        String[] arr2 = {"김구", "안중근", "윤봉길", "유관순"};
        hello2(arr); // 이 경우 names 배열의 개수는 4이다.
        System.out.println("-------------------------");
    }
}