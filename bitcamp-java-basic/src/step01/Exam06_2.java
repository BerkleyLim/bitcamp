// 부동 소숫점의 리터럴(literal) - 크기
package step01;
public class Exam06_2 {
    public static void main(String[] args) {

        // 부동소숫점도 크기에 따라 작성하는 방법이 다르다.
        System.out.println(3.14); // 8바이트 크기의 부동 소수점

        // 부동소숫점 뒤에 F나 f를 붙이면 4바이트 크기의 부동소숫점으로 다룬다.
        //  - 주로 소문자를 붙인다.
        System.out.println(3.14f); // 4바이트 크기의 부동 소수점

        // 궁금점?
        //  - 정수는 메모리의 크기에 따라 최소값과 최대값이 정해짐
        //  - 부동소수점의 최소/최댓값은?
        ...
        // 다음 값은 4byte 메모리 범위를 넘어가는 부동소수점이기 때문에
        // 값은 짤린다.
        ...
        // 다음 값은 8byte 메모리 범위 안에서 표현 가능한 부동소수점이기 때문에
        // 정상적으로 출력된다.
        ...
        // 해결책?
        //  - 시스템에서 필요한 만큼 소수점 이하를 자리수를 적절히 짤라 사용하라!        
    }
}

// 결론!
// - 32비트(float) 메모리에 부동소수점을 저장할 대는
//   유효자릿수 7자리까지는 (거의) 가능하다.
// - 64비트(double) 메모리에 부동소수점을 저장할 때는
//   유효자리수 15자리까지는 (거의) 가능하다.
