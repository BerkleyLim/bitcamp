...
public class Exam01_1 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 다른 생성자를 사용하여 String 인스턴스를 초기화 시키기
        ...
        // 이 생성자는 바이트 배열에 들어 있는 값이 iso-8859-1 라고 생각하기 때문이다.
        
        // 해결책?
        // String 클래스의 생성자 중에서 바이트 배열과 인코딩 정보를 함게 받는 생성자를 호출하라!
        // => 즉 bytes 배열에 EUC-KR의 코드 값이들어 있다고 알려준다.
