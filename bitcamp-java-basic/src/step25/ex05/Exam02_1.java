...
//    - 예) Mybatis 등
// 2) OR Mapper
//    - 전용언어 및  문법(Domain-Sepcific Language; DSL)을 사용하여 작성
//     살행할 때 DBMS에 맞춰서 SQL을 생성하여 실행한다.
...
public class Exam02_1 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // sqlSession 객체를 이용하여 SQL 맴퍼 파일에 작성한 SQL 문을 실행한다.
