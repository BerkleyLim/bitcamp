...
public class C2 extends C {
    // 다음은 C의 멧드를 오버라이딩 한 계 아니다!
    // 왜? C의 m1()은 private이기 때문에 C에서만 사용할 수 있다.
    ...
    */
    ...
    // => 옵라이딩이라면 @Override 애노테이션을 붙였을 때 오류가 나지 말아야 한다!
    private void m1() { }
    ...
    */
    ...
    //@Override private void m2() {} // 컴파일 오류! protected => private으로 접근을 좁혀서
    ...
    //@Override void m4() {} // 컴파일 오류! (public) ==> protected
}
...
// 결론!
// 수퍼 클래스의 메서드를 자식 클래스가 재정을 할 때
// 접근 범위를 확대 가능하지만 좁힐 수 없음
