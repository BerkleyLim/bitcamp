...
public class Exam02_3 extends C {
    public static void main(String[] args) {
        ...
        //    당연히 그 메서드는 외붕서 호출할 수 있도록 public으로 공개되었다.
        Calendar cal1 = Calendar.getInstance();
        Calendar cal2 = Calendar.getInstance();
        System.out.println(cal1 == cal2); // 같으면 singleton, 다르면 factory 패턴
        ...
        // 생성자를 protected로 감추고, getInstance()를 공개하였다.
        // 캡슐화를 응용한 예이다.
    }
