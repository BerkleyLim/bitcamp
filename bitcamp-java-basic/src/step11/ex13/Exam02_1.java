...
public class Exam02_1 extends C {
    public static void main(String[] args) {
        ...
        obj1.defaultVar = 100; // OK! 이 클래스는 A 클래스와 같은 패키지에 소속되어있다.
        ...
        obj4.protectedVar = 100;  // OK! C의 Exam02_1는 C의 자식 클래스이며,
...
// protected   : (default) + 자신 클래스에서 자신이 만든 변수일 경우
// public      : 모두 접근 가능
...
// => 그 클래스 내부에서만 사용되는 메서드는 접근을 private로 접근을 제한한다.
