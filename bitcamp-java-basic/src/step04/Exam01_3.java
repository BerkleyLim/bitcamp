...
public class Exam01_3 {
    public static void main (String[] args) {
        ...
        // - 임시 4byte 메모리를 만든 다음에 그 메모리에 값을 저장한 후
        //   연산을 수행한다.
        // - 당연히 그 연산 결과를 담은 메모리도 4byte이기 때문에
