...
public class Exam01_5 {
    public static void main (String[] args) {
        ...
        // byte + short = int
        // => byte와 short 값은 int로 암시적으로 형변환 된다.
        //short r3 = b + s; // 컴파일 오류!!
...
// <용어 정리>
// dynamic type binding : PHP, Python, Ruby에 주로 쓰임.
//        컴파일러가 없는 경우 주로 쓰임
// static type binding : 컴파일러가 있는 경우, java

// 정리!
// - 연산은 항상 같은 타입끼리만 가능하다.
// - 그래서 다른 타입끼리 연산을 할 때는 둘 중 한개의 타입을 다른 타입을
//   바꿔야 한다.
// - 타입을 바꾸는 것을 내부적인 규칙에 따라 자동으로 처리한다고 해서
//   "암시적 형변환(implicit type conversion)" 이라 부른다.
// - 암시적 형변환 규칙
//   다음과 같이 오른족 타입의 값으로 자동 변환시킨다.
