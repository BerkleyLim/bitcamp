...
public class Exam08_3 {
    public static void main(String[] args) {
        ...
        d = i; // long(8) ==> double(8)
               // long(64비트) 값 double 메모리에 저장할 때
               // 53비트 가수부를 넘어간다면 짤린다.
               // 주의! 컴파일 오류가 발생하지 않는다.
        System.out.println(d);

        l = 18_2345_3456_4567_5678L;  // 53bit 넘어가는 정수
        d = l; // long(8) ==> double(8)
               // long(64비트) 값 double 메모리에 저장할 때
               // 53비트 가수부를 넘어간다면 짤린다.
               // 주의! 컴파일 오류가 발생하지 않는다.
...
// 부동소숫점 메모리(float, double)에 저장할 대
// 주의해서 사용하라!
// 큰 정수 값이 부동소숫점 메모리에 저장될 때 짤릴 수 있다.
// 컴파일 오류가 발생하지 않기 때문에
// 개발자들이 놓치는 경우가 많다.