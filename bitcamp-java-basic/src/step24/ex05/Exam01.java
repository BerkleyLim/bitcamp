// 비동기 방식으로 인한 문제 및 해결 책!!!!!!
package step24.ex05;

public class Exam01 {
    public static void main(String[] args) {
        Account account = new Account("111-11-1111-111", 1_000_0);
        ...
        // 오류 발생 이유:
        // 쓰레드는 동시 다발성의 특성을 지니기 때문에. 서로 자료를 중복해서 다루면 치명적인 오류 발생
        // 즉, 교착상태가 없기 때문에 값이 나오지 않는다.
        
        // 강남, 서초 등 여러 개의 스레드가
        // 같은 객체에 대해 메서드를 호출하여 동시에 값을 변경하려 할 때
        // 서로 그 메모리의 값을 덮어쓰는 문제가 발생한다.
        // 이처럼 여러 스레드가 동시에 실행할 때 문제가 발생하는 코드들을
        // "Critical Section(=Critical region) = 임계구역" 이라 부른다.
        ...
        // 주의!
        // => 여러 스레드가 같은 메모리에 대해 같을 조회할 때는 문제가 발생하지 않는다.
    }
}
...
// 뮤텍스(상호 배제)(mutual exclusion; MUTEX)
