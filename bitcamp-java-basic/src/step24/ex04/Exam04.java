// 스레드의 생명주기(lifecycle) - running 상태 : CPU 쟁탈전
package step24.ex04;
...
//      원래의 낮은 우선 순위를 높임으로써(aging) 결국에는 모든 프로세스와 스레드가
//      실행을 완료할 수 있게 한다.
