...
적용된다. 수동으로 처리하고 싶다면 autocommit을 false 로 설정하라.
```
...
연습1:
```
insert into test1(name, tel) value ('xxx', '1111');
insert into test1(name, tel) value ('yyy', '2222');
insert into test1(name, tel) value ('zzz', '2222');
